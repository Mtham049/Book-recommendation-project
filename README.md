### To make book recommendations using content-based filtering, we are attempting to extract the hyperlinks and tags that are kept on the Wikipedia article for each specific book.
